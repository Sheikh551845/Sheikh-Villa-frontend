...
export default function Registration() {
  ...
  return (
    <div className=" mx-auto pt-40 md:pt-44 mb-32">
      <div className="relative flex w-72  md:w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md mx-auto ">
  <div className="relative mx-2  md:mx-4 -mt-6 mb-4 grid h-20 md:h-28 place-items-center overflow-hidden rounded-xl bg-gradient-to-r from-gray-400 to-gray-600  bg-clip-border text-white shadow-lg shadow-gray-600">
  ...
  <div className="card flex-shrink-0  md:w-full max-w-xs md:max-w-sm shadow-2xl bg-base-100">
                        <form onSubmit={handleSubmit} className="card-body">
                            ...
                            <div className="form-control mt-6 p-0">
                                <button className="btn  bg-gradient-to-r from-gray-400 to-gray-600 text-white" type='submit'>Register</button>
                            </div>
